 ...
 * that publish it as a GitHub release asset (releases take files up to 2 GB). Nothing is uploaded here.
...
console.log(`\n  DB_SEED_URL=https://github.com/${repo}/releases/download/db-seed/outset-seed.db`);
