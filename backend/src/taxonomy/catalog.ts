...
export const METROS: MetroDef[] = [
  ...
  { id: "waterloo", name: "Waterloo", region: "ON", country: "CA", kind: "metro" , lat: 43.46, lon: -80.52 },
  { id: "hamilton", name: "Hamilton", region: "ON", country: "CA", kind: "metro" , lat: 43.26, lon: -79.87 },
  { id: "london", name: "London", region: "ON", country: "CA", kind: "inland" , lat: 42.98, lon: -81.25 },
