...
export const METROS: Metro[] = [
  ...
  { id: "waterloo", name: "Waterloo", region: "ON", country: "CA" },
  { id: "hamilton", name: "Hamilton", region: "ON", country: "CA" },
  { id: "london", name: "London", region: "ON", country: "CA" },
...
export const METRO_ALIASES: Record<string, string[]> = {
  ...
  waterloo: ["kitchener", "kitchener waterloo", "kw", "waterloo region"],
